...
namespace TaskManagement.MVC.Controllers
{
    ...
    public class TasksController : Controller
    {
        ...
        // 2. MY TASKS (Filtered down to the logged-in user)
        [HttpGet]
        ...
        public async Task<IActionResult> CreateAjax([FromBody] TaskViewModel model)
        {
            ...
            // Agar backend API fail hota hai toh uska real error message read karein
        ...
        {
            // ✅ FIXED: DeleteAsync returns an HttpResponseMessage now, making line 147 compile smoothly!
